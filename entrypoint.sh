...
OCTOPUS_RELEASE_VERSION="${GITVERSION_NUGETVERSION}:${GITHUB_RUN_NUMBER}"
echo "OCTOPUS_RELEASE_VERSION=$OCTOPUS_RELEASE_VERSION" >> "$GITHUB_ENV"

echo "::add-mask::$GITHUB_PACKAGES_TOKEN"
echo "GITHUB_PACKAGES_TOKEN=$GITHUB_PACKAGES_TOKEN" >> "$GITHUB_ENV"